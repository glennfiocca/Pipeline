...
export function JobCard({ job, onApply, onSave, isApplied, onClick, isApplying }: JobCardProps) {
            ...
            <div className="flex gap-2">
              {onSave && (
                <Button 
                  variant="outline" 
                  size="sm" 
                  onClick={(e) => handleButtonClick(e, () => onSave(job.id))}
                >
              ...
              <Button
                ...
                size="sm"
                onClick={(e) => handleButtonClick(e, () => onApply(job.id))}
